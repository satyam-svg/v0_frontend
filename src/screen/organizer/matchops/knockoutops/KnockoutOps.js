    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                if (response) {
                    router.push(`/organizer/match-ops/knockout-ops/${values.categoryId}`);
                } else {
...
export default KnockoutOpsScreen; 